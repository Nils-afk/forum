<?php
/* Smarty version 4.3.1, created on 2023-05-12 16:35:55
  from '/home/vol1000_8/epizy.com/epiz_34193542/htdocs/custom/templates/DefaultRevamp/forum/view_topic.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_645e4ecb3cd699_63231709',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e82ee957297e0f2a3dd1423587ea71127d2c1d4d' => 
    array (
      0 => '/home/vol1000_8/epizy.com/epiz_34193542/htdocs/custom/templates/DefaultRevamp/forum/view_topic.tpl',
      1 => 1683900930,
      2 => 'file',
    ),
  ),
...
function content_645e4ecb3cd699_63231709 (Smarty_Internal_Template $_smarty_tpl) {
...
echo $_smarty_tpl->tpl_vars['TOPIC_TITLE']->value;?>
    ...
    <div class="sub header">
        <?php echo $_smarty_tpl->tpl_vars['STARTED_BY']->value;?>
                        ...
                        <div class="item">
                            <div class="content">
                                ...
                                <div class="res right floated description">
                                    <?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['reply']->value['user_topics_count'],'/[^0-9]+/','');?>
</div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="content">
                                ...
                                <div class="res right floated description">
                                    <?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['reply']->value['user_posts_count'],'/[^0-9]+/','');?>
</div>
                            </div>
                        </div>
                    </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <div class="ui eleven wide tablet thirteen wide computer column" id="post-content">
                    ...
                    <div class="ui mini info message" id="reactions">
                        ...
                        <a href="#" data-toggle="popup" data-position="right center"><?php echo $_smarty_tpl->tpl_vars['LIKE']->value;?>
</a>
...
"
            style="<?php echo $_smarty_tpl->tpl_vars['reply']->value['user_style'];?>
"><?php echo $_smarty_tpl->tpl_vars['reply']->value['username'];?>
</a> &middot; <span data-toggle="tooltip"
            data-content="<?php echo $_smarty_tpl->tpl_vars['reply']->value['post_date'];?>
"><?php echo $_smarty_tpl->tpl_vars['reply']->value['post_date_rough'];?>
</span>
        <?php if ($_smarty_tpl->tpl_vars['reply']->value['edited'] !== null) {?>&middot; <span data-toggle="tooltip"
            data-content="<?php echo $_smarty_tpl->tpl_vars['reply']->value['edited_full'];?>
...
" data-variation="mini" data-inverted=""><i
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['reply']->value) {
$_smarty_tpl->tpl_vars['reply']->do_else = false;
if (count($_smarty_tpl->tpl_vars['reply']->value['post_reactions'])) {?>
...
<?php }
if ((isset($_smarty_tpl->tpl_vars['CAN_MODERATE']->value))) {?>
...
" name="token" />
        ...
        <a type="submit" class="ui positive button"
            onclick="document.getElementById('deleteTopic').submit()"><?php echo $_smarty_tpl->tpl_vars['DELETE']->value;?>
</a>
    </div>
</div>
<?php }?>
